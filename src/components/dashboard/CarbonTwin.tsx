...
import type { CarbonTwinData } from '../../types';

export const CarbonTwin: React.FC = React.memo(() => {
  const twinData: CarbonTwinData = useMemo(() => ({
    score: 780,
    topSources: [
      { name: 'Transport', value: 45, color: 'bg-greenmind-primary' },
      { name: 'Energy', value: 30, color: 'bg-greenmind-secondary' },
      { name: 'Food', value: 15, color: 'bg-greenmind-accent' },
      { name: 'Shopping', value: 10, color: 'bg-white' },
    ],
    insight: 'Based on your Carbon Twin analysis, transportation contributes 45% of your total emissions.',
    recommendations: [
      ...
      <CardContent>
        <div className="flex flex-col md:flex-row items-center justify-around py-8 gap-8">
          ...
          <div className="flex-1 w-full space-y-4">
            ...
            {twinData.topSources.map((item, i) => (
        ...
        <div className="mt-8 bg-greenmind-primary/5 border border-greenmind-primary/20 rounded-xl p-6 relative overflow-hidden">
          ...
          <p className="text-sm text-gray-300 mb-5 leading-relaxed">
            <span className="font-semibold text-greenmind-primary">AI Insight:</span> {twinData.insight}
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
            ...
            <div className="bg-black/20 p-4 rounded-lg border border-white/5">
              ...
              <ul className="space-y-2.5">
                {twinData.estimatedImpact.map((impact, i) => (
                  <li key={i} className="text-sm text-greenmind-secondary flex items-start gap-2 font-medium">
...
CarbonTwin.displayName = 'CarbonTwin';
